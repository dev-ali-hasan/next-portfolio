      ...
      <div className="max-w-4xl mx-auto relative">
        <div className="bg-(--bg-secondary)/20 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-(--border-secondary) text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="group flex items-center gap-3 bg-linear-to-r from-(--bg-tertiary)  to-[#9ED83F]/80 text-(--text-primary) px-6 py-3 rounded-xl font-medium hover:shadow-xl hover:shadow-[#9ED83F]/10 transition-all duration-300 text-[16px] md:text-xl cursor-pointer">
